...
NESS <- function(GCP, data, cell_type = NULL, rareness = FALSE, data.name,
    ...
    if(rareness) {
      metric_plots[["Rareness Score(Mean)"]] <- plot_improved(GCP, rare.mean, "Rareness Score(Mean)",paste0(data.name, method, " - Rareness Score(Mean) (", init_type, ")"))
      metric_plots[["Rareness Score(Variance)"]] <- plot_improved(GCP, rare.var, "Rareness Score(Variance)",paste0(data.name, method, " - Rareness Score(Variance) (", init_type, ")"))
    }
